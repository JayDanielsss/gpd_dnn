...
def compute_f2(t, fe, fg):
    tau = -1. * t/ (4. * _MASS_OF_PROTON_IN_GEV**1)
    numerator = fg - fe
    denominator = 1. + tau
...
xsec_test_fig.savefig(f"{SCRATCH_PATH}/version_{VERSION_NUMBER}/data/unp_beam_unp_target_check_v{MAJOR_MINOR_NUMBER}.png")
xsec_test_fig.savefig(f"{SCRATCH_PATH}/version_{VERSION_NUMBER}/data/unp_beam_unp_target_check_v{MAJOR_MINOR_NUMBER}.eps")
...
xsec_test_ax[1].legend(fontsize = 14.3)
xsec_test_ax[0].grid(visible = True)
xsec_test_fig.savefig(f"{SCRATCH_PATH}/version_{VERSION_NUMBER}/data/plus_beam_unp_target_check_v{MAJOR_MINOR_NUMBER}.png")
xsec_test_fig.savefig(f"{SCRATCH_PATH}/version_{VERSION_NUMBER}/data/plus_beam_unp_target_check_v{MAJOR_MINOR_NUMBER}.eps")
plt.close(xsec_test_fig)
...
xsec_test_ax[1].legend(fontsize = 14.3)
xsec_test_ax[0].grid(visible = True)
xsec_test_fig.savefig(f"{SCRATCH_PATH}/version_{VERSION_NUMBER}/data/minus_beam_unp_target_check_v{MAJOR_MINOR_NUMBER}.png")
xsec_test_fig.savefig(f"{SCRATCH_PATH}/version_{VERSION_NUMBER}/data/minus_beam_unp_target_check_v{MAJOR_MINOR_NUMBER}.eps")
plt.close(xsec_test_fig)
...
xsec_test_ax[1].legend(fontsize = 14.3)
xsec_test_ax[0].grid(visible = True)
xsec_test_fig.savefig(f"{SCRATCH_PATH}/version_{VERSION_NUMBER}/data/unp_beam_lp_target_check_v{MAJOR_MINOR_NUMBER}.png")
xsec_test_fig.savefig(f"{SCRATCH_PATH}/version_{VERSION_NUMBER}/data/unp_beam_lp_target_check_v{MAJOR_MINOR_NUMBER}.eps")
plt.close(xsec_test_fig)
...
xsec_test_ax[1].legend(fontsize = 14.3)
xsec_test_ax[0].grid(visible = True)
xsec_test_fig.savefig(f"{SCRATCH_PATH}/version_{VERSION_NUMBER}/data/plus_beam_lp_target_check_v{MAJOR_MINOR_NUMBER}.png")
xsec_test_fig.savefig(f"{SCRATCH_PATH}/version_{VERSION_NUMBER}/data/plus_beam_lp_target_check_v{MAJOR_MINOR_NUMBER}.eps")
plt.close(xsec_test_fig)
...
xsec_test_ax[1].legend(fontsize = 14.3)
xsec_test_ax[0].grid(visible = True)
xsec_test_fig.savefig(f"{SCRATCH_PATH}/version_{VERSION_NUMBER}/data/minus_beam_lp_target_check_v{MAJOR_MINOR_NUMBER}.png")
xsec_test_fig.savefig(f"{SCRATCH_PATH}/version_{VERSION_NUMBER}/data/minus_beam_lp_target_check_v{MAJOR_MINOR_NUMBER}.eps")
plt.close(xsec_test_fig)
...
bsa_fig.savefig(f"{SCRATCH_PATH}/version_{VERSION_NUMBER}/data/unp_bsa_check_v{MAJOR_MINOR_NUMBER}.png")
bsa_fig.savefig(f"{SCRATCH_PATH}/version_{VERSION_NUMBER}/data/unp_bsa_check_v{MAJOR_MINOR_NUMBER}.eps")
plt.close(bsa_fig)
...
bsa_axes[1].legend(fontsize = 14.3)
bsa_axes[0].grid(visible = True)
bsa_fig.savefig(f"{SCRATCH_PATH}/version_{VERSION_NUMBER}/data/plus_lp_bsa_check_v{MAJOR_MINOR_NUMBER}.png")
bsa_fig.savefig(f"{SCRATCH_PATH}/version_{VERSION_NUMBER}/data/plus_lp_bsa_check_v{MAJOR_MINOR_NUMBER}.eps")
plt.close(bsa_fig)
...
bsa_axes[1].legend(fontsize = 14.3)
bsa_axes[0].grid(visible = True)
bsa_fig.savefig(f"{SCRATCH_PATH}/version_{VERSION_NUMBER}/data/minus_lp_bsa_check_v{MAJOR_MINOR_NUMBER}.png")
bsa_fig.savefig(f"{SCRATCH_PATH}/version_{VERSION_NUMBER}/data/minus_lp_bsa_check_v{MAJOR_MINOR_NUMBER}.eps")
plt.close(bsa_fig)
...
xsec_test_ax[1].legend(fontsize = 14.3)
xsec_test_ax[0].grid(visible = True)
xsec_test_fig.savefig(f"{SCRATCH_PATH}/version_{VERSION_NUMBER}/data/unp_tsa_check_v{MAJOR_MINOR_NUMBER}.png")
xsec_test_fig.savefig(f"{SCRATCH_PATH}/version_{VERSION_NUMBER}/data/unp_tsa_check_v{MAJOR_MINOR_NUMBER}.eps")
plt.close(xsec_test_fig)
...
xsec_test_ax[1].legend(fontsize = 14.3)
xsec_test_ax[0].grid(visible = True)
xsec_test_fig.savefig(f"{SCRATCH_PATH}/version_{VERSION_NUMBER}/data/plus_beam_tsa_check_v{MAJOR_MINOR_NUMBER}.png")
xsec_test_fig.savefig(f"{SCRATCH_PATH}/version_{VERSION_NUMBER}/data/plus_beam_tsa_check_v{MAJOR_MINOR_NUMBER}.eps")
plt.close(xsec_test_fig)
...
xsec_test_ax[1].legend(fontsize = 14.3)
xsec_test_ax[0].grid(visible = True)
xsec_test_fig.savefig(f"{SCRATCH_PATH}/version_{VERSION_NUMBER}/data/minus_beam_tsa_check_v{MAJOR_MINOR_NUMBER}.png")
xsec_test_fig.savefig(f"{SCRATCH_PATH}/version_{VERSION_NUMBER}/data/minus_beam_tsa_check_v{MAJOR_MINOR_NUMBER}.eps")
plt.close(xsec_test_fig)
...
xsec_test_ax[1].legend(fontsize = 14.3)
xsec_test_ax[0].grid(visible = True)
xsec_test_fig.savefig(f"{SCRATCH_PATH}/version_{VERSION_NUMBER}/data/dsa_check_v{MAJOR_MINOR_NUMBER}.png")
xsec_test_fig.savefig(f"{SCRATCH_PATH}/version_{VERSION_NUMBER}/data/dsa_check_v{MAJOR_MINOR_NUMBER}.eps")
plt.close(xsec_test_fig)
