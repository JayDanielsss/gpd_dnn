...
tf_plus_beam_cross_section_km15 = bkm10_cross_section(
    +1.0, 0.0,
    TEST_QSQ, TEST_XB, TEST_T, TEST_EP, TEST_Y, TEST_XI, TEST_K, TEST_F1, TEST_F2, TEST_K_TILDE, TEST_T_PRIME, phi_array_in_radians, TEST_P1, TEST_P2,
    CFF_REAL_H_KM15, CFF_REAL_HT_KM15, CFF_REAL_E_KM15, CFF_REAL_ET_KM15, CFF_IMAG_H_KM15, CFF_IMAG_HT_KM15, CFF_IMAG_E_KM15, CFF_IMAG_ET_KM15)
...
tf_minus_beam_cross_section_km15 = bkm10_cross_section(
    -1.0, 0.0,
    TEST_QSQ, TEST_XB, TEST_T, TEST_EP, TEST_Y, TEST_XI, TEST_K, TEST_F1, TEST_F2, TEST_K_TILDE, TEST_T_PRIME, phi_array_in_radians, TEST_P1, TEST_P2,
    CFF_REAL_H_KM15, CFF_REAL_HT_KM15, CFF_REAL_E_KM15, CFF_REAL_ET_KM15, CFF_IMAG_H_KM15, CFF_IMAG_HT_KM15, CFF_IMAG_E_KM15, CFF_IMAG_ET_KM15)
...
bkm10_lp_km15 = km15_cross_section.compute_cross_section(
    phi_array_in_radians,
    lepton_helicity = 0.0,
    target_polarization = +0.5).real
    
tf_lp_km15 = bkm10_cross_section(
    0.0, +0.5,
    TEST_QSQ, TEST_XB, TEST_T, TEST_EP, TEST_Y, TEST_XI, TEST_K, TEST_F1, TEST_F2, TEST_K_TILDE, TEST_T_PRIME, phi_array_in_radians, TEST_P1, TEST_P2,
    CFF_REAL_H_KM15, CFF_REAL_HT_KM15, CFF_REAL_E_KM15, CFF_REAL_ET_KM15, CFF_IMAG_H_KM15, CFF_IMAG_HT_KM15, CFF_IMAG_E_KM15, CFF_IMAG_ET_KM15)
...
tf_plus_beam_lp_km15 = bkm10_cross_section(
    +1.0, +0.5,
    TEST_QSQ, TEST_XB, TEST_T, TEST_EP, TEST_Y, TEST_XI, TEST_K, TEST_F1, TEST_F2, TEST_K_TILDE, TEST_T_PRIME, phi_array_in_radians, TEST_P1, TEST_P2,
    CFF_REAL_H_KM15, CFF_REAL_HT_KM15, CFF_REAL_E_KM15, CFF_REAL_ET_KM15, CFF_IMAG_H_KM15, CFF_IMAG_HT_KM15, CFF_IMAG_E_KM15, CFF_IMAG_ET_KM15)
...
tf_minus_beam_lp_km15 = bkm10_cross_section(
    +1.0, +0.5,
    TEST_QSQ, TEST_XB, TEST_T, TEST_EP, TEST_Y, TEST_XI, TEST_K, TEST_F1, TEST_F2, TEST_K_TILDE, TEST_T_PRIME, phi_array_in_radians, TEST_P1, TEST_P2,
    CFF_REAL_H_KM15, CFF_REAL_HT_KM15, CFF_REAL_E_KM15, CFF_REAL_ET_KM15, CFF_IMAG_H_KM15, CFF_IMAG_HT_KM15, CFF_IMAG_E_KM15, CFF_IMAG_ET_KM15)
...
tf_unp_target_bsa_km15 = bkm10_bsa(
    0.0, 0.0,
    TEST_QSQ, TEST_XB, TEST_T, TEST_EP, TEST_Y, TEST_XI, TEST_K, TEST_F1, TEST_F2, TEST_K_TILDE, TEST_T_PRIME, phi_array_in_radians, TEST_P1, TEST_P2,
    CFF_REAL_H_KM15, CFF_REAL_HT_KM15, CFF_REAL_E_KM15, CFF_REAL_ET_KM15, CFF_IMAG_H_KM15, CFF_IMAG_HT_KM15, CFF_IMAG_E_KM15, CFF_IMAG_ET_KM15)
...
cross_section_fig, cross_section_axes = plt.subplots(1, 2, figsize = (14, 7))
cross_section_axes[0].scatter(
    phi_array_in_radians, bkm10_cross_sections_km15,
    s = 4., label = "BKM10 Prediction with KM15 CFFs", color = "blue")
cross_section_axes[1].scatter(
...
cross_section_axes.set_ylabel(r"$d^{4}\sigma^{UU}$", fontsize = 16)
...
cross_section_fig.savefig(f"{SCRATCH_PATH}/version_{VERSION_NUMBER}/data/xsec_vs_phi_v{MAJOR_MINOR_NUMBER}.png")
cross_section_fig.savefig(f"{SCRATCH_PATH}/version_{VERSION_NUMBER}/data/xsec_vs_phi_v{MAJOR_MINOR_NUMBER}.eps")
...
cross_section_axes[0].scatter(
    ...
    s = 4., label = "BKM10 Prediction with KM15 CFFs", color = "blue")
cross_section_axes[1].scatter(
    phi_array_in_radians, (bkm10_plus_beam_cross_sections_km15 - tf_plus_beam_cross_section_km15),
    color = "gray", s = 2., label = "Residuals: BKM10(KM15) - TF(KM15)")
cross_section_axes.set_xlabel(r"$\phi$ [radians]", fontsize = 16)
cross_section_axes.set_ylabel(r"$d^{4}\sigma^{+U}$", fontsize = 16)
cross_section_axes.set_title(f"{title_string}\n(KM15): {km15_cff_string}")
cross_section_axes.legend(fontsize = 14.3)
cross_section_axes.grid(visible = True)
cross_section_fig.savefig(f"{SCRATCH_PATH}/version_{VERSION_NUMBER}/data/xsec_plus_beam_vs_phi_v{MAJOR_MINOR_NUMBER}.png")
cross_section_fig.savefig(f"{SCRATCH_PATH}/version_{VERSION_NUMBER}/data/xsec_plus_beam_vs_phi_v{MAJOR_MINOR_NUMBER}.eps")
plt.close(cross_section_fig)
...
cross_section_axes[0].scatter(
    ...
    s = 4., label = "BKM10 Prediction with KM15 CFFs", color = "blue")
cross_section_axes[1].scatter(
    phi_array_in_radians, (bkm10_minus_beam_cross_sections_km15 - tf_minus_beam_cross_section_km15),
    color = "gray", s = 2., label = "Residuals: BKM10(KM15) - TF(KM15)")
cross_section_axes.set_xlabel(r"$\phi$ [radians]", fontsize = 16)
cross_section_axes.set_ylabel(r"$d^{4}\sigma^{-U}$", fontsize = 16)
cross_section_axes.set_title(f"{title_string}\n(KM15): {km15_cff_string}")
cross_section_axes.legend(fontsize = 14.3)
cross_section_axes.grid(visible = True)
cross_section_fig.savefig(f"{SCRATCH_PATH}/version_{VERSION_NUMBER}/data/xsec_minus_beam_vs_phi_v{MAJOR_MINOR_NUMBER}.png")
cross_section_fig.savefig(f"{SCRATCH_PATH}/version_{VERSION_NUMBER}/data/xsec_minus_beam_vs_phi_v{MAJOR_MINOR_NUMBER}.eps")
plt.close(cross_section_fig)
...
cross_section_fig, cross_section_axes = plt.subplots(1, 2, figsize = (14, 7))
cross_section_axes[0].scatter(
    phi_array_in_radians, bkm10_lp_km15,
    s = 4., label = "BKM10 Prediction with KM15 CFFs", color = "blue")
cross_section_axes[1].scatter(
    phi_array_in_radians, (bkm10_lp_km15 - tf_lp_km15),
    color = "gray", s = 2., label = "Residuals: BKM10(KM15) - TF(KM15)")
cross_section_axes.set_xlabel(r"$\phi$ [radians]", fontsize = 16)
cross_section_axes.set_ylabel(r"$d^{4}\sigma^{UL}$", fontsize = 16)
cross_section_axes.set_title(f"{title_string}\n(KM15): {km15_cff_string}")
cross_section_axes.legend(fontsize = 14.3)
cross_section_axes.grid(visible = True)
cross_section_fig.savefig(f"{SCRATCH_PATH}/version_{VERSION_NUMBER}/data/lp_xsec_vs_phi_v{MAJOR_MINOR_NUMBER}.png")
cross_section_fig.savefig(f"{SCRATCH_PATH}/version_{VERSION_NUMBER}/data/lp_xsec_vs_phi_v{MAJOR_MINOR_NUMBER}.eps")
plt.close(cross_section_fig)
...
cross_section_axes[0].scatter(
    ...
    s = 4., label = "BKM10 Prediction with KM15 CFFs", color = "blue")
cross_section_axes[1].scatter(
    phi_array_in_radians, (bkm10_plus_beam_lp_cross_sections_km15 - tf_plus_beam_lp_km15),
    color = "gray", s = 2., label = "Residuals: BKM10(KM15) - TF(KM15)")
cross_section_axes.set_xlabel(r"$\phi$ [radians]", fontsize = 16)
cross_section_axes.set_ylabel(r"$d^{4}\sigma^{+L}$", fontsize = 16)
cross_section_axes.set_title(f"{title_string}\n(KM15): {km15_cff_string}")
cross_section_axes.legend(fontsize = 14.3)
cross_section_axes.grid(visible = True)
cross_section_fig.savefig(f"{SCRATCH_PATH}/version_{VERSION_NUMBER}/data/lp_xsec_plus_beam_vs_phi_v{MAJOR_MINOR_NUMBER}.png")
cross_section_fig.savefig(f"{SCRATCH_PATH}/version_{VERSION_NUMBER}/data/lp_xsec_plus_beam_vs_phi_v{MAJOR_MINOR_NUMBER}.eps")
plt.close(cross_section_fig)
...
cross_section_axes[0].scatter(
    ...
    s = 4., label = "BKM10 Prediction with KM15 CFFs", color = "blue")
cross_section_axes[1].scatter(
    phi_array_in_radians, (bkm10_minus_beam_lp_cross_sections_km15 - tf_minus_beam_lp_km15),
    color = "gray", s = 2., label = "Residuals: BKM10(KM15) - TF(KM15)")
cross_section_axes.set_xlabel(r"$\phi$ [radians]", fontsize = 16)
cross_section_axes.set_ylabel(r"$d^{4}\sigma^{-L}$", fontsize = 16)
cross_section_axes.set_title(f"{title_string}\n(KM15): {km15_cff_string}")
cross_section_axes.legend(fontsize = 14.3)
cross_section_axes.grid(visible = True)
cross_section_fig.savefig(f"{SCRATCH_PATH}/version_{VERSION_NUMBER}/data/lp_xsec_minus_beam_vs_phi_v{MAJOR_MINOR_NUMBER}.png")
cross_section_fig.savefig(f"{SCRATCH_PATH}/version_{VERSION_NUMBER}/data/lp_xsec_minus_beam_vs_phi_v{MAJOR_MINOR_NUMBER}.eps")
plt.close(cross_section_fig)
...
bsa_axes.set_ylabel(r"BSA$\left( \Lambda = 0 \right)$", fontsize = 16)
bsa_axes.set_title(f"{title_string}\n(KM15): {km15_cff_string}")
bsa_axes.legend(fontsize = 14)
bsa_axes.grid(visible = True)
bsa_fig.savefig(f"{SCRATCH_PATH}/version_{VERSION_NUMBER}/data/bsa_vs_phi_v{MAJOR_MINOR_NUMBER}.png")
bsa_fig.savefig(f"{SCRATCH_PATH}/version_{VERSION_NUMBER}/data/bsa_vs_phi_v{MAJOR_MINOR_NUMBER}.eps")
plt.close(bsa_fig)
...
bsa_axes[1].scatter(
    ...
    color = "gray", s = 2., label = "Residuals: BKM10(KM15) - TF(KM15)")
bsa_axes.set_xlabel(r"$\phi$ [radians]", fontsize = 16)
bsa_axes.set_ylabel(r"BSA$\left( \Lambda = +1/2 \right)$", fontsize = 16)
bsa_axes.set_title(f"{title_string}\n(KM15): {km15_cff_string}")
bsa_axes.legend(fontsize = 14)
bsa_axes.grid(visible = True)
bsa_fig.savefig(f"{SCRATCH_PATH}/version_{VERSION_NUMBER}/data/bsa_plus_lp_vs_phi_v{MAJOR_MINOR_NUMBER}.png")
bsa_fig.savefig(f"{SCRATCH_PATH}/version_{VERSION_NUMBER}/data/bsa_plus_lp_vs_phi_v{MAJOR_MINOR_NUMBER}.eps")
plt.close(bsa_fig)
