##########################################
# FILE INFORMATION:
# Purpose: checks if the tensorflow models 
# successfully matches the library predictions
# Created: 20260107
...
with open(file = f"./version_{MAJOR_MINOR_NUMBER}/log_set_{kinematic_set_number}_v{MAJOR_MINOR_NUMBER}.txt", mode = "w", buffering = 1) as logfile:

    logfile.write(f"[INFO]: #{kinematic_set_number}: Iteration with bin: k = {fixed_k}, Q^2 = {fixed_q_squared}, xb = {fixed_x_bjorken}, t = {fixed_t}\n")
    ...
    xsec_test_fig.savefig(f"{SCRATCH_PATH}/version_{MAJOR_MINOR_NUMBER}/kinematic_set_{kinematic_set_number}/data/unp_beam_unp_target_check_v{MAJOR_MINOR_NUMBER}.png")
    xsec_test_fig.savefig(f"{SCRATCH_PATH}/version_{MAJOR_MINOR_NUMBER}/kinematic_set_{kinematic_set_number}/data/unp_beam_unp_target_check_v{MAJOR_MINOR_NUMBER}.eps")
    ...
    xsec_test_ax[1].legend(fontsize = 14.3)
    xsec_test_ax[0].grid(visible = True)
    xsec_test_fig.savefig(f"{SCRATCH_PATH}/version_{MAJOR_MINOR_NUMBER}/kinematic_set_{kinematic_set_number}/data/plus_beam_unp_target_check_v{MAJOR_MINOR_NUMBER}.png")
    xsec_test_fig.savefig(f"{SCRATCH_PATH}/version_{MAJOR_MINOR_NUMBER}/kinematic_set_{kinematic_set_number}/data/plus_beam_unp_target_check_v{MAJOR_MINOR_NUMBER}.eps")
    plt.close(xsec_test_fig)
    ...
    xsec_test_ax[1].legend(fontsize = 14.3)
    xsec_test_ax[0].grid(visible = True)
    xsec_test_fig.savefig(f"{SCRATCH_PATH}/version_{MAJOR_MINOR_NUMBER}/kinematic_set_{kinematic_set_number}/data/minus_beam_unp_target_check_v{MAJOR_MINOR_NUMBER}.png")
    xsec_test_fig.savefig(f"{SCRATCH_PATH}/version_{MAJOR_MINOR_NUMBER}/kinematic_set_{kinematic_set_number}/data/minus_beam_unp_target_check_v{MAJOR_MINOR_NUMBER}.eps")
    plt.close(xsec_test_fig)
    ...
    xsec_test_ax[1].legend(fontsize = 14.3)
    xsec_test_ax[0].grid(visible = True)
    xsec_test_fig.savefig(f"{SCRATCH_PATH}/version_{MAJOR_MINOR_NUMBER}/kinematic_set_{kinematic_set_number}/data/unp_beam_lp_target_check_v{MAJOR_MINOR_NUMBER}.png")
    xsec_test_fig.savefig(f"{SCRATCH_PATH}/version_{MAJOR_MINOR_NUMBER}/kinematic_set_{kinematic_set_number}/data/unp_beam_lp_target_check_v{MAJOR_MINOR_NUMBER}.eps")
    plt.close(xsec_test_fig)
    ...
    xsec_test_ax[1].legend(fontsize = 14.3)
    xsec_test_ax[0].grid(visible = True)
    xsec_test_fig.savefig(f"{SCRATCH_PATH}/version_{MAJOR_MINOR_NUMBER}/kinematic_set_{kinematic_set_number}/data/plus_beam_lp_target_check_v{MAJOR_MINOR_NUMBER}.png")
    xsec_test_fig.savefig(f"{SCRATCH_PATH}/version_{MAJOR_MINOR_NUMBER}/kinematic_set_{kinematic_set_number}/data/plus_beam_lp_target_check_v{MAJOR_MINOR_NUMBER}.eps")
    plt.close(xsec_test_fig)
    ...
    xsec_test_ax[1].legend(fontsize = 14.3)
    xsec_test_ax[0].grid(visible = True)
    xsec_test_fig.savefig(f"{SCRATCH_PATH}/version_{MAJOR_MINOR_NUMBER}/kinematic_set_{kinematic_set_number}/data/minus_beam_lp_target_check_v{MAJOR_MINOR_NUMBER}.png")
    xsec_test_fig.savefig(f"{SCRATCH_PATH}/version_{MAJOR_MINOR_NUMBER}/kinematic_set_{kinematic_set_number}/data/minus_beam_lp_target_check_v{MAJOR_MINOR_NUMBER}.eps")
    plt.close(xsec_test_fig)
    ...
    bsa_fig.savefig(f"{SCRATCH_PATH}/version_{MAJOR_MINOR_NUMBER}/kinematic_set_{kinematic_set_number}/data/unp_bsa_check_v{MAJOR_MINOR_NUMBER}.png")
    bsa_fig.savefig(f"{SCRATCH_PATH}/version_{MAJOR_MINOR_NUMBER}/kinematic_set_{kinematic_set_number}/data/unp_bsa_check_v{MAJOR_MINOR_NUMBER}.eps")
    plt.close(bsa_fig)
    ...
    bsa_axes[1].legend(fontsize = 14.3)
    bsa_axes[0].grid(visible = True)
    bsa_fig.savefig(f"{SCRATCH_PATH}/version_{MAJOR_MINOR_NUMBER}/kinematic_set_{kinematic_set_number}/data/plus_lp_bsa_check_v{MAJOR_MINOR_NUMBER}.png")
    bsa_fig.savefig(f"{SCRATCH_PATH}/version_{MAJOR_MINOR_NUMBER}/kinematic_set_{kinematic_set_number}/data/plus_lp_bsa_check_v{MAJOR_MINOR_NUMBER}.eps")
    plt.close(bsa_fig)
    ...
    bsa_axes[1].legend(fontsize = 14.3)
    bsa_axes[0].grid(visible = True)
    bsa_fig.savefig(f"{SCRATCH_PATH}/version_{MAJOR_MINOR_NUMBER}/kinematic_set_{kinematic_set_number}/data/minus_lp_bsa_check_v{MAJOR_MINOR_NUMBER}.png")
    bsa_fig.savefig(f"{SCRATCH_PATH}/version_{MAJOR_MINOR_NUMBER}/kinematic_set_{kinematic_set_number}/data/minus_lp_bsa_check_v{MAJOR_MINOR_NUMBER}.eps")
    plt.close(bsa_fig)
    ...
    xsec_test_ax[1].legend(fontsize = 14.3)
    xsec_test_ax[0].grid(visible = True)
    xsec_test_fig.savefig(f"{SCRATCH_PATH}/version_{MAJOR_MINOR_NUMBER}/kinematic_set_{kinematic_set_number}/data/unp_tsa_check_v{MAJOR_MINOR_NUMBER}.png")
    xsec_test_fig.savefig(f"{SCRATCH_PATH}/version_{MAJOR_MINOR_NUMBER}/kinematic_set_{kinematic_set_number}/data/unp_tsa_check_v{MAJOR_MINOR_NUMBER}.eps")
    plt.close(xsec_test_fig)
    ...
    xsec_test_ax[1].legend(fontsize = 14.3)
    xsec_test_ax[0].grid(visible = True)
    xsec_test_fig.savefig(f"{SCRATCH_PATH}/version_{MAJOR_MINOR_NUMBER}/kinematic_set_{kinematic_set_number}/data/plus_beam_tsa_check_v{MAJOR_MINOR_NUMBER}.png")
    xsec_test_fig.savefig(f"{SCRATCH_PATH}/version_{MAJOR_MINOR_NUMBER}/kinematic_set_{kinematic_set_number}/data/plus_beam_tsa_check_v{MAJOR_MINOR_NUMBER}.eps")
    plt.close(xsec_test_fig)
    ...
    xsec_test_ax[1].legend(fontsize = 14.3)
    xsec_test_ax[0].grid(visible = True)
    xsec_test_fig.savefig(f"{SCRATCH_PATH}/version_{MAJOR_MINOR_NUMBER}/kinematic_set_{kinematic_set_number}/data/minus_beam_tsa_check_v{MAJOR_MINOR_NUMBER}.png")
    xsec_test_fig.savefig(f"{SCRATCH_PATH}/version_{MAJOR_MINOR_NUMBER}/kinematic_set_{kinematic_set_number}/data/minus_beam_tsa_check_v{MAJOR_MINOR_NUMBER}.eps")
    plt.close(xsec_test_fig)
    ...
    xsec_test_ax[1].legend(fontsize = 14.3)
    xsec_test_ax[0].grid(visible = True)
    xsec_test_fig.savefig(f"{SCRATCH_PATH}/version_{MAJOR_MINOR_NUMBER}/kinematic_set_{kinematic_set_number}/data/dsa_check_v{MAJOR_MINOR_NUMBER}.png")
    xsec_test_fig.savefig(f"{SCRATCH_PATH}/version_{MAJOR_MINOR_NUMBER}/kinematic_set_{kinematic_set_number}/data/dsa_check_v{MAJOR_MINOR_NUMBER}.eps")
    plt.close(xsec_test_fig)
